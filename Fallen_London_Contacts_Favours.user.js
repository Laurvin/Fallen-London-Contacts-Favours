...
$(document).ready(function ()
{
	...
	if (location.href == 'http://fallenlondon.storynexus.com/Me/StatusesForCategory?category=Contacts')
	{
		...
		CreatedHTML += '<div class="FLCFdivs">&nbsp;</div><div class="FLCFdivs" id="FLCFreload" style="cursor:pointer"><img height="26" width="20" border="0" src="//d39jqyxiuv7ej3.cloudfront.net/icons/bellsmall.png" /></div>';
	...
	else
	{
		...
		$("body").append('<iframe src="http://fallenlondon.storynexus.com/Me/StatusesForCategory?category=Contacts" id="gmIframe"></iframe>');
